...
- detection
- `detection`
- Что считается ground truth: прямоугольники, обводящие пешеходов
- Какие предсказания использовались: 0.3 для V1, 0.7 для V2
- Комментарий (2-4 предложения): модель, обученная на coco способна узнавать людей на картинках. с изменением порога уверенности можно расширить возможную выборку и попадания в людей, но также и увеличить количество ошибок
