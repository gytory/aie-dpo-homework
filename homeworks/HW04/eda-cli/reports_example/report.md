...
- Есть колонки с одинаковыми значениями: **False**
- Слишком много категориальных значений в колонках: **True**
...
Показаны топ-5 значений для каждой категориальной колонки.
