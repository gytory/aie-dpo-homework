...
def report(
    ...
    title: Optional[str] = typer.Option(None, help="Заголовок отчёта. Если не указан, используется стандартный."),
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Слишком много категориальных значений в колонках: **{quality_flags['has_high_cardinality_categoricals']}**\n\n")
        f.write("## Колонки\n\n")
        ...
        if not top_cats:
            ...
            f.write(f"Показаны топ-{top_k_categories} значений для каждой категориальной колонки.\n")
