...
### Пример вызовы report с параметрами

```bash
uv run eda-cli report data/example.csv --title "Проверка" --top-k-categories 3
```
Задан новый заголовок - Проверка - и количество выводимых категорий - 3.
---
